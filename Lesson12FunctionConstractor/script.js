...
//  5) контекст функция внутри функции объекта либо window, либо undefined;
//но стрелочная функция ()=> своего контекста не имеет поэтому ссылается на контекст родителя
//-------------------------------------------------------------
